...
func ParseCLIArguments() *constants.ParamsConfig {
	...
	flag.StringVar(&config.AzureVaultCredentials, "azureVaultCredentials", "", "This is an optional parameter and it would only be passed when the registryProvider is azure and it represents the credentials for the Azure ACR registry.")
